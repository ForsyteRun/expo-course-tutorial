...
export default function TabsLayout() {
  ...
  return (
    <Tabs screenOptions={{ tabBarActiveTintColor: 'green', headerShown: false, animation: 'fade' }}>
      ...
      <Tabs.Screen name="explore" options={{ tabBarLabel: 'Explorer', tabBarIcon: ({ color, size }) => <FontAwesome name="wpexplorer" size={size} color={color} /> }} />
      <Tabs.Screen name="progress" options={{ tabBarLabel: 'Progress', tabBarIcon: ({ color, size }) => <MaterialCommunityIcons name="progress-check" size={size} color={color} /> }} />
